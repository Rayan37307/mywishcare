...
const Navbar = ({ toggleMenu, toggleCart, onUserIconClick }: NavbarProps) => {
    ...
    <nav className={navbarClasses}>
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center">
          <button 
            className="p-2 rounded-md focus:outline-none transition-colors duration-200 cursor-pointer"
            onClick={toggleMenu}
      ...
      <path d="M15.857 15.858 21 21.001" stroke="currentColor" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round"></path>
          ...
          <button 
            className="p-2 rounded-md relative transition-colors duration-200 cursor-pointer"
            onClick={toggleCart}
          ...
          >
            ...
            {/* {totalItems > 0 && ( */}
              <span className="absolute top-0.5 -right-[3px] bg-[#D4F871] text-black text-xs rounded-full h-4 w-4 flex items-center justify-center">
                {totalItems}
              </span>
            {/* )} */}
          </button>
...
// UserDropdown component for accessible user menu
...
const UserDropdown: React.FC<UserDropdownProps> = ({ user, navigate, handleLogout }) => {
