...
const RoutineBuilder = () => {
  ...
  }, [routineBuilderProducts.length]); // Removed fetchRoutineBuilderProducts from dependency to prevent infinite loop
...
const RoutineBuilderCardItem: React.FC<RoutineBuilderCardItemProps> = ({ 
  product, 
  handleAddToCart, 
  isAddingItem 
}) => {
